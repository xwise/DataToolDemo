package dk.siemens.enginnering.datatool.web.rest;

import dk.siemens.enginnering.datatool.DataToolDemoApp;

import dk.siemens.enginnering.datatool.domain.Baseline;
import dk.siemens.enginnering.datatool.domain.FileEntry;
import dk.siemens.enginnering.datatool.repository.BaselineRepository;
import dk.siemens.enginnering.datatool.service.BaselineService;
import dk.siemens.enginnering.datatool.service.dto.BaselineDTO;
import dk.siemens.enginnering.datatool.service.mapper.BaselineMapper;
import dk.siemens.enginnering.datatool.web.rest.errors.ExceptionTranslator;
import dk.siemens.enginnering.datatool.service.dto.BaselineCriteria;
import dk.siemens.enginnering.datatool.service.BaselineQueryService;
...
import static dk.siemens.enginnering.datatool.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import dk.siemens.enginnering.datatool.domain.enumeration.BaselineStatus;
/**
...
@SpringBootTest(classes = DataToolDemoApp.class)
public class BaselineResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllBaselinesByFileEntryIsEqualToSomething() throws Exception {
        // Initialize the database
        FileEntry fileEntry = FileEntryResourceIntTest.createEntity(em);
        em.persist(fileEntry);
        em.flush();
        baseline.addFileEntry(fileEntry);
        baselineRepository.saveAndFlush(baseline);
        Long fileEntryId = fileEntry.getId();

        // Get all the baselineList where fileEntry equals to fileEntryId
        defaultBaselineShouldBeFound("fileEntryId.equals=" + fileEntryId);

        // Get all the baselineList where fileEntry equals to fileEntryId + 1
        defaultBaselineShouldNotBeFound("fileEntryId.equals=" + (fileEntryId + 1));
    }
