...
import dk.siemens.enginnering.datatool.web.rest.errors.BadRequestAlertException;
import dk.siemens.enginnering.datatool.web.rest.util.HeaderUtil;
import dk.siemens.enginnering.datatool.service.dto.MyFirstComponentDTO;
import dk.siemens.enginnering.datatool.service.dto.MyFirstComponentCriteria;
import dk.siemens.enginnering.datatool.service.MyFirstComponentQueryService;
...
public class MyFirstComponentResource {
    ...
    private final MyFirstComponentQueryService myFirstComponentQueryService;

    public MyFirstComponentResource(MyFirstComponentService myFirstComponentService, MyFirstComponentQueryService myFirstComponentQueryService) {
        this.myFirstComponentService = myFirstComponentService;
        this.myFirstComponentQueryService = myFirstComponentQueryService;
    }
    ...
    @Timed
    public ResponseEntity<List<MyFirstComponentDTO>> getAllMyFirstComponents(MyFirstComponentCriteria criteria) {
        log.debug("REST request to get MyFirstComponents by criteria: {}", criteria);
        List<MyFirstComponentDTO> entityList = myFirstComponentQueryService.findByCriteria(criteria);
